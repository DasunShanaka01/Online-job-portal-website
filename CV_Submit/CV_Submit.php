...
<head>
    ...
    <script src="submit_alerts.js" ></script> <!-- Include the JavaScript file -->
</head>
...
<body>
    ...
    <!--Body-->
    <h1 align="center">Submit Resume</h1>
    <br><br>
    <form method="POST" action="CVinsert.php" onsubmit="submitAlert()">
        <fieldset>

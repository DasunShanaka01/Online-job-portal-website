...
<?php
   require 'config.php';
?>
    <h1>Job Details Submitted Successfully!</h1>
    <p>Your job details have been successfully submitted. What would you like to do next?</p>
    <ul>
        <li><a href="postjobnew.php">Post another Job !</a></li><br>
        <li><a href="read.php">Read Job Details</a></li><br>
        <li><a href="update_form.php">Update Job Details</a></li><br>
        <li><a href="deleteform.php">Delete Job Details</a></li><br>


        <!-- Add option for deleting job details if needed -->
    </ul>
